...
public class AcercaDe extends JDialog {
	...
	public AcercaDe() {
		...
		gridBagLayout.columnWidths = new int[]{31, 198, 80, 236, 0};
		gridBagLayout.rowHeights = new int[]{27, 24, 37, 41, 49, 41, 0};
		...
		gbc_lblAutor.anchor = GridBagConstraints.NORTH;
